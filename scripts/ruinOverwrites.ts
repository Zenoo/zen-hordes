...
export const overwriteRuinData = (ruins: Record<number, Ruin>) => {
  ...
  ruins[5]?.drops.push(...[{ id: "bike_part_#00", odds: 0 }]);

  // MAC_S_ATOMIC_CAFE drops
  ruins[11]?.drops.push(...[{ id: "quantum_#00", odds: 0 }]);

  // DUKE_S_VILLA drops
  ruins[18]?.drops.push(...[{ id: "bike_part_#00", odds: 0 }]);
  ...
  // GARDEN_SHED drops
  ruins[27]?.drops.push(...[{ id: "soccer_#00", odds: 0 }]);

  // LOOTED_SUPERMARKET drops
  ruins[28]?.drops.push(...[{ id: "quantum_#00", odds: 0 }]);

  // FAIRGROUND_STALL drops
  ruins[31]?.drops.push(...[{ id: "soccer_#00", odds: 0 }]);
  ...
  ruins[58]?.drops.push(...[{ id: "shoe_#00", odds: 0 }]);
