...
const T: Translations = {
  en: {
    ...
    "status.tamer_watch_1": "Stand guard",
    foundIn: "Found in",
  ...
  fr: {
    ...
    "status.tamer_watch_1": "Surveille",
    foundIn: "Trouvé dans",
  ...
  de: {
    ...
    "status.infection": "Infiziert",
    "status.immune": "Immunisiert",
    "status.tg_meta_wound": "Verletzt",
    "status.terror": "Terrorisiert",
    "status.healed": "Geheilt",
    "status.drunk": "Betrunken",
    "status.thirst1": "Durstig",
    "status.thirst2": "Dehydriert",
    "status.addict": "Süchtig",
    "status.hasdrunk": "Hat getrunken",
    "status.haseaten": "Hat gegessen",
    "status.tg_shaman_immune": "Immunisiert gegen rote Seelen",
    "status.tg_april_ooze": "Infiziert am nächsten Tag",
    "status.tamer_watch_1": "Wache halten",
    foundIn: "Gefunden in",
